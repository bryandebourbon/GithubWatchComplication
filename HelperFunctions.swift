...
struct GridCalculator {
    ...
    func calculateBlockWidth(containerWidth: CGFloat, monthLabelWidth: CGFloat, padding: CGFloat) -> CGFloat {
        (containerWidth - monthLabelWidth - padding * (CGFloat(numberOfColumns) + 2)) / CGFloat(numberOfColumns)
    }
